...
import { updateUserPermissions } from './authApi';
...
export default function AdminDashboard({ onLogout }) {
  ...
  const handleApproveUser = async (userId, username) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/approve', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleRejectUser = async (userId, username) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/reject', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handlePromoteToAdmin = async (userId, username) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/role', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
